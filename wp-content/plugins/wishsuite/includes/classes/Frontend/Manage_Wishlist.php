...
class Manage_Wishlist {
    ...
    public function add_to_cart_html( $product, $quentity ) {
        ...
        $quick_add_to_cart = wishsuite_get_option( 'enable_quick_add_to_cart','wishsuite_table_settings_tabs','on' );
        ...
        $btn_class .= $quick_add_to_cart === 'on' ? ' wishsuite_quick_add_to_cart' : '';
        ...
        if( 'variable' === $product->get_type() && $quick_add_to_cart === 'on' ):
        ?>
